...
import { PokemonListState, initialPokemonComparisonState, pokemonListReducer } from "./pokemonComparison.reducer"
...
describe('pokemonListReducer', () => {
    ...
    describe('getPokemonListRequestError action', () => {
        it('should handle getPokemonListRequestError action', () => {
            ...
            const state = pokemonListReducer(initialPokemonComparisonState, action)

            expect(state).toEqual(initialPokemonComparisonState)
        })
    })
    ...
    describe('getNextPokemonListPageRequestSuccess action', () => {
        ...
        it('should handle getNextPokemonListPageRequestSuccess action', () => {
            ...
            expect(state.list).toEqual(initialPokemonComparisonState.list.concat(pokemonsSut.results))
            expect(state.query).toEqual({
                ...state.query,
                currentPage: initialPokemonComparisonState.query.currentPage + 1,
            })
        })
    })
    ...
    describe('updatePokemonListQueryFilters action', () => {
        ...
        it('should handle updatePokemonListQueryFilters action', () => {
            ...
            expect(state).toEqual({
                ...initialPokemonComparisonState, 
                query: {...initialPokemonComparisonState.query, 
                    filters: filtersSut
                }
            })
        })
    ...
    describe('updatePokemonTypeFilter action', () => {
        ...
        it('should handle updatePokemonTypeFilter action if byType is selected', () => {
            const initialState = {
                ...initialPokemonComparisonState,
                query: {
                    ...initialPokemonComparisonState.query,
                    filters: {
                        ...initialPokemonComparisonState.query.filters,
                    }
                },
            } as PokemonListState
