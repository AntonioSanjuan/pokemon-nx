...
import { selectPokemonQuery } from './pokemonComparison.selectors';
...
describe('PokemonListEffects', () => {
  ...
  let pokemonListService: PokemonComparitionService;
  let store:  MockStore;;
  ...
  beforeEach(() => {
    ...
    pokemonListService = TestBed.inject(PokemonComparitionService)
  });
